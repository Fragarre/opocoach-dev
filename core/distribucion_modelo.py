...
Archivo : distribucion_modelo.py
Ruta    : core/distribucion_modelo.py

Objetivo:
    Proporcionar la distribución oficial de preguntas por tipo y tema.

Entradas:
    - Configuración consolidada del examen modelo.
...
Flujo:
    1. Carga la distribución definida.
    2. Devuelve una copia utilizable.
