...
Objetivo:
    Validar y clasificar temáticamente preguntas importadas.
...
Salidas:
    - Estado, parte, tema, norma, artículo y trazabilidad.
...
Flujo:
    1. Detecta referencias normativas.
    2. Busca documentos o fragmentos candidatos.
    3. Recurre a IA cuando es necesario.
    4. Aplica umbrales y devuelve la clasificación.
