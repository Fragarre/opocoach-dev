...
Objetivo:
    Cargar, normalizar y detectar normas mediante sus alias.

Entradas:
    - config/normas.csv.
    - Texto con referencias normativas.

Salidas:
    - Catálogo de normas y coincidencias detectadas.
...
Flujo:
    1. Carga el CSV.
    2. Normaliza títulos y alias.
    3. Detecta coincidencias.
