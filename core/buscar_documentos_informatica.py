...
Objetivo:
    Localizar documentos de informática relevantes para una pregunta.
...
Salidas:
    - Documentos de informática ordenados por relevancia.
...
Flujo:
    1. Carga los documentos de informática.
    2. Normaliza y tokeniza el texto.
    3. Calcula coincidencias.
