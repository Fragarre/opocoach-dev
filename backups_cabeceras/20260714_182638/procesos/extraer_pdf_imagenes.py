...
Extrae preguntas desde un PDF formado por imágenes.

Cada página debe contener:
- una pregunta;
- cuatro opciones A, B, C y D;
- una respuesta correcta marcada en verde;
- una referencia normativa en el pie.

Genera un JSON para revisión.
