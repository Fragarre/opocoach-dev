...
Importa preguntas extraídas desde un PDF de imágenes.

Comportamiento:
- valida norma y artículo mediante el pie;
- asigna parte y tema;
- clasifica directamente GENERAL e INFORMÁTICA;
- deja la parte Especial pendiente para distinguir
  ESPECIAL_TEORIA y ESPECIAL_PRACTICA;
- omite preguntas defectuosas sin detener el lote;
- omite preguntas duplicadas;
- genera un JSON de incidencias.

Las preguntas RECHAZADA y A_REVISAR sí se conservan
en preguntas_importadas, pero no serán seleccionadas
por el generador de simulacros.
"""
...
def crear_argumentos():
    ...
    parser.add_argument(
        "json",
        help="Ruta del JSON generado por la extracción.",
    )

    parser.add_argument(
        "pdf",
        help="Ruta del PDF original.",
    )
