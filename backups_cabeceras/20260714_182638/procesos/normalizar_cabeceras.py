...
Objetivo:
    Auditar las cabeceras de los scripts Python del proyecto y generar
    un informe con las cabeceras correctas, incompletas o inexistentes.

Entradas:
    - Archivos .py de core, procesos y render.
...
Flujo:
    ...
    2. Lee la cabecera de cada archivo.
    3. Comprueba los campos obligatorios.
    4. Clasifica el resultado.
    5. Genera el informe Markdown.

Observaciones:
    - No modifica ningún script.
    - Los archivos __init__.py vacíos se consideran correctos.
