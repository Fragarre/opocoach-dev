...
Objetivo:
    Analizar dependencias entre scripts y generar un informe para detectar
    módulos activos, procesos ejecutables y posibles archivos obsoletos.
...
Flujo:
    1. Localiza los scripts Python.
    2. Extrae imports internos y funciones principales.
    3. Calcula qué scripts utilizan cada módulo.
    4. Identifica procesos ejecutables y archivos aislados.
    5. Genera un informe para revisión manual.

Observaciones:
    - No elimina ni modifica scripts.
    - Un proceso ejecutado manualmente puede ser válido aunque ningún módulo
      lo importe.
