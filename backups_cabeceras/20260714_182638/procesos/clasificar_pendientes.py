...
Funcionalidad:
Clasifica un lote limitado de preguntas importadas pendientes.

El script:

- selecciona preguntas con estado_validacion = PENDIENTE;
- carga sus opciones;
- delega toda la clasificación en core.clasificador.Clasificador;
- muestra el resultado de cada pregunta;
- guarda los resultados únicamente cuando se utiliza --guardar;
- realiza una única transacción para todo el lote.

No contiene lógica propia de clasificación.
