...
Funcionalidad:
Representa en memoria el temario completo de una convocatoria.

Carga el fichero CFG y construye índices de consulta para relacionar:
...
Este módulo es el único componente autorizado para interpretar directamente
la estructura del temario definida en el CFG.
