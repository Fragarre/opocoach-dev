...
Funcionalidad:
Construye el prompt utilizado por la IA para determinar si alguno de los
fragmentos candidatos justifica la respuesta oficial de una pregunta.

La IA no clasifica por tema. Únicamente identifica el fragmento normativo
que respalda la respuesta correcta y expresa su confianza.
"""
