...
Funcionalidad:
Localiza fragmentos candidatos mediante BM25.

La búsqueda queda limitada siempre a los documentos incluidos en el
temario de la convocatoria.

Puede buscar:

- dentro de una norma concreta;
- globalmente en todo el temario.

BM25 únicamente devuelve candidatos. No valida preguntas.
"""
