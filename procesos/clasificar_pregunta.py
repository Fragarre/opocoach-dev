...
Objetivo:
    Clasificar y auditar una pregunta concreta.

Entradas:
    - Identificador de pregunta importada.

Salidas:
    - Diagnóstico y clasificación de la pregunta.
...
Flujo:
    ...
    3. Muestra o guarda el resultado.
