...
Objetivo:
    Añadir explicaciones justificadas a un simulacro.
...
Salidas:
    - Simulacro explicado en JSON y explicaciones reutilizables.
...
Flujo:
    1. Busca explicaciones existentes.
    2. Recupera fragmentos.
    3. Genera faltantes.
    4. Guarda.
