...
Objetivo:
    Asignar GENERAL, ESPECIAL_TEORIA, ESPECIAL_PRACTICA o ESPECIAL_INFORMATICA.

Entradas:
    - Preguntas validadas sin tipo.

Salidas:
    - Tipo de pregunta actualizado.
...
Flujo:
    1. Carga pendientes.
    2. Analiza parte y redacción.
    3. Asigna el tipo definitivo.
